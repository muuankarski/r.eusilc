...
# pandoc --toc --number-section -s -S -H /home/aurelius/web/css/rmarkdown.css -r markdown+grid_tables+table_captions+yaml_metadata_block r.eusilc_tutorial.md -o r.eusilc_tutorial.html
...
```{rcase2data,  warning=FALSE, message=FALSE, eval=FALSE}
library(r.eusilc)
...
```{rcase2plot,  warning=FALSE, message=FALSE, eval=FALSE}
...
```{rcase3data,  warning=FALSE, message=FALSE, eval=FALSE}
library(r.eusilc)
...
```{rcase3plot,  warning=FALSE, message=FALSE, eval=FALSE}
library(ggplot2)
...
```{rcase4plot,  warning=FALSE, message=FALSE, eval=FALSE}
